...
import { useRegisterMutation, useVerifyregisterationMutation, useGetIndustryTypesMutation } from '../../../redux/userSlices/userApiSlice';
                        ...
                        <MDBCard alignment="center" className="mb-5">
                            ...
                            <MDBCardBody>
                                ...
                                >
                                    ...
                                    <div className="col-md-12">
                                        <Dropdown value={location} onChange={(e) => setLocation(e.value)} options={countries} optionLabel="name" placeholder="Select a Country"
                                            filter valueTemplate={selectedCountryTemplate} itemTemplate={countryOptionTemplate} className="w-100" />

                                    </div>
                                    <div className="col-md-12">
                                        <Dropdown value={industry} onChange={(e) => setIndustry(e.value)} options={industries} optionLabel="name" placeholder="Select industry Type"
                                            filter valueTemplate={selectedIndustryTemplate} itemTemplate={IndustryOptionTemplate} className="w-100" />

                                    </div>
                                    <div className="col-md-12">
                                        <Dropdown value={gender} onChange={(e) => Setgender(e.value)} options={genderOptions} optionLabel="name" placeholder="Select gender"
                                            filter valueTemplate={selectedCountryTemplate} itemTemplate={countryOptionTemplate} className="w-100" />

                                    </div>
                                    <div className="col-md-12">
                                        <Dropdown value={education} onChange={(e) => setEducation(e.value)} options={highestEducations} optionLabel="name" placeholder="Select Highest Education"
                                            filter valueTemplate={selectedCountryTemplate} itemTemplate={countryOptionTemplate} className="w-100" />
