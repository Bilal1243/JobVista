...
import { useAddNewPasswordMutation } from "../../../redux/userSlices/userApiSlice";
...
const ChangePassword = () => {
  ...
  const [addNewPassword, { isLoading }] = useAddNewPasswordMutation();
  ...
  const submitHandler = async (e) => {
    ...
    try {
      if (password !== confirmPassword) {
        ...
        const responseFromApiCall = await addNewPassword({
          email,
          password,
        }).unwrap();
