...
function RecruiterLogin() {
    ...
    const submitHandler = async (e) => {
        ...
        if (!email || !password) {
            ...
            try {
                const responseFromApiCall = await recruiterLogin({ email, password }).unwrap()
        ...
        <>
            <MDBContainer fluid>
                <MDBRow>
                    ...
                    <MDBCol sm='6' className='d-none d-sm-block px-0 mt-5' style={{ height: '500px', display: 'flex', alignItems: 'center' }}>
                        <img
                            src={loginBg}
                            alt="Login image"
                            style={{ objectFit: 'cover', objectPosition: 'left', maxHeight: '100%', maxWidth: '100%' }}
                        />
                    </MDBCol>
