...
import { useRecruiterVerifyOtpMutation } from "../../../redux/recruiterSlices/recruiterApiSlices";
import {
  MDBBtn,
  MDBCard,
  MDBCardBody,
...
const RecruiterVerifyOtp = () => {
  const [otp, setOtp] = useState("");
  const [recruiterVerifyOtp] = useRecruiterVerifyOtpMutation();
