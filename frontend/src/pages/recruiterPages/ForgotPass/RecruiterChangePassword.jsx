...
import { useRecruiterAddNewPassMutation } from "../../../redux/recruiterSlices/recruiterApiSlices";
...
const RecruiterChangePassword = () => {
  ...
  const [recruiterAddNewPass, { isLoading }] = useRecruiterAddNewPassMutation();
  ...
  const submitHandler = async (e) => {
    ...
    try {
      if (password !== confirmPassword) {
        ...
        const responseFromApiCall = await recruiterAddNewPass({
          email,
          password,
        }).unwrap();
